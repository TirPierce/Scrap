...
namespace GameStateManagement
{
    ...
    class TerrainTest : GameScreen
    {
        ...
        //GUI mGUI;
        TerrainPlayerMatch currentMatch;
        ...
        public override void LoadContent()
        {
            ...
            //mGUI = new GUI(ScreenManager.Game);


            mGameState = GamePlayState.BuildMode;
            currentMatch = new Scrap.GameState.TerrainPlayerMatch(ScreenManager.Game);
